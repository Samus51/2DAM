...
/**
 * Clase que representa la ventana para eliminar un cliente. Permite buscar un
 * cliente por nombre y confirmar su eliminación.
 */
public class BajaCliente extends JDialog {
	 ...
	 *
	 * @param pantalla La instancia de PantallaInicial para acceder a la lista de
	 *                 clientes.
	 */
