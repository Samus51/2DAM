...
public class HomeEmpleado extends JFrame {
	...
	private void inicializarComponentes() {
		...
		lblNewLabel.setIcon(new ImageIcon(HomeEmpleado.class.getResource("/resources/cocheAzul.png")));
		...
		lblLogOut.setIcon(new ImageIcon(HomeEmpleado.class.getResource("/resources/logout.png")));
		...
		lblCita = new JLabel("Actualizar estado reparación");
		...
		lblCita.setIcon(new ImageIcon(HomeEmpleado.class.getResource("/resources/reparaciones.png")));
		panel_6.add(lblCita);
		...
		lblReparaciones.setIcon(new ImageIcon(HomeEmpleado.class.getResource("/resources/listadoReparaciones.png")));
